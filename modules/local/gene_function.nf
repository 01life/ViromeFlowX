process gene_function {
    ...
    perl /share/app/get_path2virgene2/0.1/get_path2virgene2.pl gene2uniref.txt ${params.CAZy} > map_CAZy_uniref90.out.disorder
    ...
    perl /share/app/get_path2virgene2/0.1/get_path2virgene2.pl gene2uniref.txt ${params.eggnog} > map_eggnog_uniref90.out
    cut -f 1,2 map_eggnog_uniref90.out > map_eggnog_uniref90.out.txt

    perl /share/app/get_path2virgene2/0.1/get_path2virgene2.pl gene2uniref.txt ${params.go} > map_go_uniref90.out
    cut -f 1,2 map_go_uniref90.out > map_go_uniref90.out.txt

    perl /share/app/get_path2virgene2/0.1/get_path2virgene2.pl gene2uniref.txt ${params.ko} > map_ko_uniref90.out
    cut -f 1,2 map_ko_uniref90.out > map_ko_uniref90.out.txt

    perl /share/app/get_path2virgene2/0.1/get_path2virgene2.pl gene2uniref.txt ${params.level4ec} > map_level4ec_uniref90.out
    cut -f 1,2 map_level4ec_uniref90.out > map_level4ec_uniref90.out.txt

    perl /share/app/get_path2virgene2/0.1/get_path2virgene2.pl gene2uniref.txt ${params.pfam} > map_pfam_uniref90.out
