process CRASS {
    ...
    script:
    """
    /ehpcdata/PM/DATA/RD23010035/app/blast/2.10.0+/blastp -db ${params.crAss_db1} -query ${prodigals} -evalue 1e-10 -num_threads 2 -outfmt '6 qaccver saccver pident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen qcovs qcovhsp qcovus' -out blastp.out
    ...
    /ehpcdata/PM/DATA/RD23010035/app/blast/2.10.0+/blastn -db ${params.crAss_db2} -query crAss-like.len70k.list.fasta -evalue 1e-10 -num_threads 2 -outfmt '6 qseqid qlen sseqid sgi slen pident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen qcovs qcovhsp qcovus' -out NC_024711.blastn.out
