process classify_genome {
    ...
    /ehpcdata/PM/DATA/RD23010035/app/taxonkit/0.7.2/taxonkit lca --data-dir ${params.genome_data} blastn.out.top5.contig2taxids.2 > contig.tmp
    ...
    /ehpcdata/PM/DATA/RD23010035/app/taxonkit/0.7.2/taxonkit lineage --data-dir ${params.genome_data} blastn.out.top5.contig2taxids.lca.2 > blastn.out.top5.contig2taxids.lca.2.line
    /ehpcdata/PM/DATA/RD23010035/app/taxonkit/0.7.2/taxonkit reformat --data-dir ${params.genome_data} blastn.out.top5.contig2taxids.lca.2.line -P > blastn.out.top5.contig2taxids.lca.2.line.reformat
